...
const typeConfig = {
    ...
    audio: {
        dir: path.join(uploadRootDir, 'audios'),
        urlPrefix: '/uploads/audios',
        extensions: ['.mp3', '.wav'],
    ...
    doc: {
        ...
        extensions: ['.pdf', '.doc', '.docx', '.ppt', '.pptx', '.xls', '.xlsx', '.txt', '.csv'],
        mimes: [
            'application/pdf',
            'application/msword',
    ...
    data: {
        dir: path.join(uploadRootDir, 'data'),
        urlPrefix: '/uploads/data',
        extensions: ['.json'],
